...
export default {
   ...
   options: {
      ...
      owner: ["6283873494075"], // set owner number on here
      sessionName: "Gans", // for name session
      prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i,
      pairingNumber: "6283873494075" // Example Input : 62xxx
   },
...
link: {
channel: 'https://youtube.com/@survivofc'
}
}
